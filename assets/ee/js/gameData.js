    ...
    return {
        ...
        canyon: {
            ...
            objects: [
                ...
                { type: 'chest', x: 400, y: 200, contains: 'artifact1', text: "Wrapped in oilcloth inside: half of a notched wooden stick. The oilcloth is modern. Someone cached this here recently — someone protecting it." },
        ...
        hohokam_site: {
            ...
            objects: [
                ...
                { type: 'looter_pit', x: 460, y: 380, text: "A fresh pit, dug at night, screened neatly. Pothunters — and they knew exactly where to dig. That's the frightening part." },
            ...
            npcs: [
                { name: 'Dr. Delgado', x: 350, y: 200, dialog: [
                    ...
                    "If you find anything out there — anything — document, don't dig. Promise me that, Professor."
                ]}
            ],
            enemies: [
        ...
        asu_lab: {
            name: 'ASU — Hayden Archives & Lab', background: '#4A4A52', indoor: true,
            objects: [
